...
- test_guests_set_min_qos
  ...
  **Note** - Network cabable Min Qos must be marked in test_betwork as min_qos=number(kbps). 
...
- test_guests_with_min_bw
  ...
  This test create vm with port direct port set with min_qos set with int value. 

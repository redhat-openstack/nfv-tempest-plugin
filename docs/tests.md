...
Definition of the networks according to the numa nodes required.

**Note** - The test suit only for RHOS version 13 and up, since the numa aware vswitch feature was implemented only in version 14 and backported to 13.

...
NfvPluginOptions = [
    ...
    cfg.StrOpt('hypervisor_tuning_details',
               default='[{"packages": ["tuned-2.*", "tuned-profiles-.*", '
                       '"openvswitch2.*"]}, '
                       '{"services": ["tuned", "openvswitch"]}, '
                       '{"tuned_profiles": ["cpu-partitioning", '
                       '"realtime-virtual-host"]}, '
                       '{"kernel_args": ["hugepages", "hugepagesz", '
                       '"default_hugepagesz", "iommu=pt", "intel_iommu=on", '
                       '"isolcpus", "nohz=on", "nohz_full", "rcu_nocbs", '
                       '"tuned.non_isolcpus", "intel_pstate"]}]',

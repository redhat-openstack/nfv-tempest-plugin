...
class RedfishClient:
    ...
    def connect(self):
        self.client = redfish.redfish_client(base_url=f"https://{self.ip}",
    ...
    def get_power_state(self):
        ...
        chassis_member_id = chassis_response.dict.get("Members", [])[0].get("@odata.id")
        ...
        power_data_response = self.client.get(chassis_member_id + "/Power/", None)
        ...
        power_consumed_watts = power_data_response.dict.get("PowerControl", [])[0].get("PowerConsumedWatts")

...
class TestDpdkScenarios(base_test.BaseTest):
    ...
    def test_derived_parameters(self):
        ...
        with the current assigned values
        ...
        """
        Retrieve parameter values from current deployment according to
        the derived parameters present in JSON file
        """
        for param in derived_params:
            if param not in retrive_host_params:

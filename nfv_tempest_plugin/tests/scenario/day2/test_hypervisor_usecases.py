...
from nfv_tempest_plugin.tests.common.parallel_utils import ParallelUtils
...
class TestHypervisorScenarios(base_test.BaseTest, Day2Manager, ParallelUtils):
    ...
    def test_scale_out_kernelargs_hypervisor_reboot(self, test='scale_out'
        ...
        self.multithread_iter_wraper(new_compute,
                                     self.validate_kargs)
        self.multithread_iter_wraper(self.novaclient_overcloud
                                     .hypervisors.list(),
    ...
    def test_stack_update_kernel_args_hypervisor_reboot(self,
        ...
        self.multithread_iter_wraper(iteratable=self

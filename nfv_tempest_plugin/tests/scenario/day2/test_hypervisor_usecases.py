...
import datetime
from nfv_tempest_plugin.services.stack_clients import StackClients
...
class TestHypervisorScenarios(base_test.BaseTest, StackClients):
    ...
    def reboot_hypervisor_and_wait(self, hypervisor):
        ...
        time.sleep(10)
        while 'down' in self.novaclient_overcloud.hypervisors.search(
    ...
    def test_scale_out_kernelargs_hypervisor_reboot(self, test='scale_out'
        ...
        """
        super(TestHypervisorScenarios, self).setup_clients()

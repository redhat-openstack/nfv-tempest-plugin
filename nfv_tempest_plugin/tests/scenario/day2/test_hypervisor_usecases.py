...
class TestHypervisorScenarios(base_test.BaseTest):
    ...
    def test_no_reboot_in_stack_update(self, stack_name='overcloud'):
        ...
        for hypervisor in hypervisors_ip:
            ...
            try:
                ...
                LOG.info('One or more of the hypervisor is not'
                         ' reachable via ssh please make sure all hypervisors'
                         ' are up')
    ...
    def reboot_validate_kernel_args(self, hypervisor, novaclient_overcloud,
        ...
        cmdline = shell_utils.run_command_over_ssh(hypervisor_ip,
                                                   'cat /proc/cmdline')\
            .split(' ')
    ...
    def multithread_wrap_validate_kernel_args_after_reboot(self):
        """wraper function for kargs validateion and reboot

        multithread for the reboot and validation of kargs update
        """
        threads = []
    ...
    def test_update_kernel_args_hypervisor_reboot(self,

...
class MultiqueueClass(object):
    ...
    def _calculate_cpu_func(self):
        ...
        LOG.info('MultiqueueClass::_calculate_cpu_func a: %d, b: %d',
                 self.pmd_cpu_a, self.pmd_cpu_b)
    ...
    def load_one_core(self, pmd_cores, minimum_load):
        ...
        LOG.info("MultiqueueClass::load_one_core chosen_core %d", core_id)
        ...
        LOG.info("MultiqueueClass::load_one_core load %d", load)
        LOG.info("MultiqueueClass::load_one_core load_per_queue %d",
                 load_per_queue)
        LOG.info("MultiqueueClass::load_one_core rate_per_queue %d",
                 rate_per_queue)

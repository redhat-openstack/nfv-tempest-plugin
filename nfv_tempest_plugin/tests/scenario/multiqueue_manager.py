...
class MultiqueueClass(object):
    ...
    def check_rebalance(self, pmd_cores, pmd_cores_2, threshold):
        ...
        if rebal:
            for core_id in pmd_cores_2.keys():
                cpu_val = 0
                for queue in pmd_cores_2[core_id]["queues"].values():
        ...
        LOG.info('MultiqueueClass::check_rebalance rebalance {}, '
                 'cpu_under_threshold {}'.format(rebal, cpu_under_threshold))

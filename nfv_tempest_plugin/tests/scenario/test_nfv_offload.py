...
class TestNfvOffload(base_test.BaseTest):
    ...
    def test_offload_icmp_transparent_vlan(self, test='offload_icmp_transparent_vlan'):
    ...
    def test_offload_udp_transparent_vlan(self, test='offload_udp_transparent_vlan'):
    ...
    def test_offload_tcp_transparent_vlan(self, test='offload_tcp_transparent_vlan'):
    ...
    def run_offload_testcase(self, test, protocol, network_type):
        ...
        :param network_type: network used (vlan, vxlan, geneve, vlan_trunk, transparent_vlan)
        """
        ...
        self.assertTrue(network_type_found, "Network type {} not found".format(network_type))

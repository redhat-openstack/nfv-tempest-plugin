...
class BareMetalManager(api_version_utils.BaseMicroversionTest,
    ...
    def setUp(self):
        ...
        # Convert compute microversion from string to float
        self.compute_microversion = float(self.compute_microversion)
        ...
        for net in self.external_config['test-networks']:
            ...
            if 'mgmt' in net and 'dns_nameservers' in net:
                self.test_network_dict[net['name']]['dns_nameservers'] = \
                    net['dns_nameservers']
            if ('tag' in net and (2.32 <= self.compute_microversion
                                  <= 2.36 or self.compute_microversion
                                  >= 2.42)):
        ...
        for port in ports['ports']:
            ...
            if port['qos_policy_id']:
                ...
                if min_bw:
                    ...
                    min_mbps = str(ceil(min_kbps / 1000))

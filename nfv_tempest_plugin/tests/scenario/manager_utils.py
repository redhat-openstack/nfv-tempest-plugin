...
class ManagerMixin(object):
    ...
    def _get_dumpxml_instance_data(self, server, hypervisor):
        ...
        container_cli = self.get_container_cli(hypervisor)
        cmd = 'sudo {} virsh -c qemu:///system dumpxml'
        if container_cli:
            cmd = cmd.format(container_cli + ' podman exec -it nova_libvirt')
        else:
            cmd = cmd.format('')
        cmd += ' {}'
        get_dumpxml = \
    ...
    def get_container_cli(self, container_cli_must=False, hypervisor=None):

...
class TestNfvBasic(base_test.BaseTest):
    ...
    def test_hypevisor_tuning(self):
        ...
        """
        packages = CONF.nfv_plugin_options.hypervisor_packages
        services = CONF.nfv_plugin_options.hypervisor_services
        tuned_profile = CONF.nfv_plugin_options.hypervisor_tuned_profile
        kernel_args = CONF.nfv_plugin_options.hypervisor_kernel_args

...
class TestMultiqueueScenarios(base_test.BaseTest):
    ...
    def prepare_vms(self, test):
        ...
        # Learn queues
        self.learn_queues(servers_dict["trex"])
    ...
    def learn_queues(self, trex_vm):
        ...
        * rate/cpu params
        ...
        cmd_training = "{} --action gen_traffic --pps \"{}\" --traffic_json {} " \
                       "--duration {} --multiplier {}".format(
            injector_config.path,
            injector_config.pps,

...
def construct_ovs_bond_tuple_from_hypervsior(hypervisor, bond_name, requested_bond_type):
    ...
    if bond_mode == requested_bond_type:
        ...
        if bond_mode == 'active-backup':
            ...
            LOG.info("Bond type {t} is not supported'"
                     .format(t=bond_mode))
    else:
        LOG.info("Bond '{b}' is not of requested type '{t}'"
                 .format(b=bond_name, b=bond_name))
    return ovs_bond

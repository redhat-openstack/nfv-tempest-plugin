...
class TestDpdkScenarios(baremetal_manager.BareMetalManager):
    ...
    def test_min_queues_functionality(self):
        self.assertTrue(self._test_queue_functionality(queues="min"))

    def test_equal_queues_functionality(self):
        self.assertTrue(self._test_queue_functionality(queues="equal"))

    def test_max_queues_functionality(self):
        self.assertFalse(self._test_queue_functionality(queues="max"))

    def test_odd_queues_functionality(self):
        self.assertTrue(self._test_queue_functionality(queues="odd"))
